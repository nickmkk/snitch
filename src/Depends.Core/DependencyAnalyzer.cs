...
namespace Depends.Core
{
    ...
    {   
        ...
        public DependencyGraph Analyze(string packageId, string version, string framework,ConcurrentDictionary<PackageIdentity, SourcePackageDependencyInfo> resolvedPackages)
        {
            using var cacheContext = new SourceCacheContext();
            return Analyze(packageId, NuGetVersion.Parse(version), framework, cacheContext, resolvedPackages);
        }

        public DependencyGraph Analyze(string packageId, NuGetVersion version, string framework, SourceCacheContext cacheContext, ConcurrentDictionary<PackageIdentity, SourcePackageDependencyInfo> resolvedPackages)
        {
